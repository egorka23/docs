...
{JSON.stringify({
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Что такое Final Merits Determination в EB-1A?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Final Merits - это второй этап оценки петиции EB-1A. На первом этапе офицер проверяет, набраны ли минимум 3 из 10 критериев. На втором этапе оценивается totality of evidence - совокупность всех доказательств, чтобы определить, относится ли заявитель к вершине профессии."
      }
    },
    {
      "@type": "Question",
      "name": "Почему отказывают на EB-1A при 3+ засчитанных критериях?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Формальное соответствие критериям на Шаге 1 не равно extraordinary ability. Согласно USCIS Policy Manual, офицер обязан перейти к Шагу 2 и оценить, доказывает ли совокупность доказательств sustained national or international acclaim. В 2025 году 97% отказов при 3+ критериях происходят именно на Final Merits."
      }
    },
    {
      "@type": "Question",
      "name": "Что такое двухэтапный анализ Kazarian?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Kazarian v. USCIS (2010) установил двухэтапный анализ EB-1A. Шаг 1: проверка формального соответствия критериям (есть ли 3 из 10). Шаг 2: оценка всех доказательств вместе для определения, является ли заявитель extraordinary. На Шаге 1 нельзя требовать citations, на Шаге 2 - можно и нужно."
      }
    },
    {
      "@type": "Question",
      "name": "Какая статистика одобрений EB-1A в 2025 году?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "По данным USCIS на FY25 Q3: approval rate около 66-67%, RFE rate 40-50%. Backlog достиг 16,000 pending cases - исторический максимум. Количество заявок выросло на 50% год-к-году."
      }
    },
    {
      "@type": "Question",
      "name": "Как усилить петицию для Final Merits?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Добавьте контекст к каждому доказательству (рейтинги, процент отбора). Используйте сравнительные метрики (топ X% по цитированиям). Покажите паттерн sustained acclaim за несколько лет. Получите independent letters от экспертов из других организаций. Свяжите все критерии в единый narrative."
      }
    },
    {
      "@type": "Question",
      "name": "Можно ли апеллировать отказ на Final Merits?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да. Варианты: AAO Appeal (30 дней, $675, 6-12+ месяцев), Motion to Reopen (новые факты), Motion to Reconsider (ошибка в применении закона). Альтернатива - переподача: часто эффективнее апелляции, особенно после NOID. 99% материалов могут остаться теми же."
      }
    },
    {
      "@type": "Question",
      "name": "Что такое sustained acclaim и как его доказать?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sustained acclaim - устойчивое признание в течение времени, не разовые достижения. Покажите паттерн роста за 5-12 лет: от региональных публикаций к международным, от первых наград к keynote выступлениям. Включите в петицию таймлайн достижений по годам."
      }
    },
    {
      "@type": "Question",
      "name": "Какой критерий EB-1A самый сложный?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Original Contributions of Major Significance - 62% отказов по этому критерию в решениях AAO. Типичные проблемы: патенты без доказательств внедрения, письма о 'потенциальном влиянии' вместо реального. Что работает: доказательства реального внедрения, конкретные примеры влияния."
      }
    }
  ]
})}
