  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px'}}>
    ...
    <div>
      ...
      <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
        ...
        <span style={{fontSize: '12px', color: '#18181b', background: '#e4e4e7', padding: '4px 10px', borderRadius: '12px', fontWeight: '500'}}>148 вопросов</span>
        <span style={{fontSize: '12px', color: '#18181b', background: '#e4e4e7', padding: '4px 10px', borderRadius: '12px', fontWeight: '500'}}>70+ цитат из RFE</span>
      </div>
    </div>
  </div>
...
**Правильно:**
- Скриншот страницы целиком с URL
- Распечатка прямо с сайта
- PDF сохраненный браузером
- Чистые копии без пометок

**Неправильно:**
- Обрезанные скриншоты
- Измененный размер
- Рукописные пометки на документах
