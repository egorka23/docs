  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px'}}>
    ...
    <div>
      ...
      <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
        ...
        <span style={{fontSize: '12px', color: '#18181b', background: '#e4e4e7', padding: '4px 10px', borderRadius: '12px', fontWeight: '500'}}>30+ цитат из RFE</span>
      </div>
    </div>
  </div>
...
**Критика #3 - YouTube = "user-edited site":**
...
> "International accessibility via the internet (such as postings in blogs, social media, web portals, search engines, podcasts, webinars, training portals, user-created content or an organization's website) is not commensurate with 'major media'."

↳ *Полный список: блоги, соцсети, порталы, поисковики, подкасты, вебинары, сайт организации - все это НЕ major media.*
