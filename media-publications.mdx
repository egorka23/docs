...
| Ваш ответ | Влияние на шансы |
|-----------|------------------|
| **Только Major Media** (широкая аудитория: КП, РБК, Forbes) | ✅ Высокие шансы |
| **Major + профильные** (50/50) | ⚠️ Средние шансы - профильные сложнее доказать |
| **В основном профильные** (нишевые издания) | ⚠️ Низкие шансы - кроме медиакита доказывать нечем |
| **Только профильные** | ❌ Очень низкие - офицеры часто отклоняют |
...
| Ваш ответ | Влияние на шансы |
|-----------|------------------|
| **PDF с URL на каждой странице** | ✅ Правильно |
| **PDF с URL только на первой странице** | ⚠️ Риск - добавьте URL вручную |
| **Скриншоты** | ❌ Отклонят - "no way to verify originality" |
| **Вырезанные куски статей** | ❌ Отклонят - "undermines credibility" |

### 3. Сколько источников доказывают Major статус каждого СМИ?

| Ваш ответ | Влияние на шансы |
|-----------|------------------|
| **SimilarWeb + 5-9 других источников** | ✅ Отлично - сложно отклонить |
| **SimilarWeb + 3-4 других источника** | ✅ Хорошо |
| **SimilarWeb + 1-2 других источника** | ⚠️ Минимум - офицер может придраться |
| **Только SimilarWeb** | ❌ Отклонят - "one source is inconclusive" |
| **Только медиакит / раздел "О нас"** | ❌ Отклонят - "self-serving assertions" |

### 4. Автор, Дата, Заголовок в каждой статье

| Ваш ответ | Влияние на шансы |
|-----------|------------------|
| **Все три есть + подсвечены в переводе** | ✅ Правильно |
| **Все три есть, но мелко / не выделены** | ⚠️ Риск - офицер может "не заметить" |
| **Автор = "Редакция" / "Editorial Staff"** | ❌ Не засчитают эту статью |
| **Нет даты публикации** | ❌ Не засчитают - "cannot be considered probative" |
...
| Ваш ответ | Влияние на шансы |
|-----------|------------------|
| **Статья целиком О ВАС и вашей работе** | ✅ Идеально |
| **Статья о теме, но вы - главный герой** | ✅ Хорошо |
| **Статья о проекте, вы упомянуты существенно** | ⚠️ Риск - зависит от офицера |
| **1-2 предложения о вас / ваша цитата** | ❌ Не засчитают - "not primarily about you" |
| **Статья о компании / событии** | ❌ Не засчитают - "about employer, not about you" |

### 6. За сколько лет собраны публикации?

| Ваш ответ | Влияние на Plain Language | Влияние на Final Merits |
|-----------|---------------------------|-------------------------|
| **5+ лет** | ✅ Отлично | ✅ "Sustained acclaim" |
| **3-4 года** | ✅ Хорошо | ⚠️ Может хватить |
| **2 года** | ✅ Засчитают | ⚠️ "Not sustained" риск |
| **1 год** | ✅ Засчитают | ❌ "Recent articles" - обесценят |
| **Только 2024-2025** | ⚠️ Засчитают, но... | ❌ "Insufficient for sustained acclaim" |
