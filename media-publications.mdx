...
|----------|----------------|
| **Explanatory Note** | Ключевая информация: возраст издания, охват, награды |
| **Urker-2021 "Лучший журнал года"** | Национальная награда Казахстана (выбран из 340 заявок, жюри международных экспертов) |
| **BusinessWire** | Официальное объявление Forbes Media о запуске 18-го локального издания (2011) |
| **Harvard Davis Center** | Признание как "major business media platform" от престижного академического института |
| **Editorial Board** | 30+ профессионалов под надзором Forbes Global Media Holdings |
| **SimilarWeb** | 1.02 млн посещений, #337 в Казахстане, 55% органический трафик |
| **Media Kit** | Тираж 10,000, контент о богатейших людях Казахстана, часть бренда Forbes (с 1917) |
| **Forbes Official Website** | 150 млн глобальной аудитории, 3.1 млн C-suite руководителей |
| **Global Editions** | 49 лицензированных изданий в 81 стране на 31 языке |
...
| Документ | Что доказывает |
|----------|----------------|
| **Лицензия Роскомнадзора** | ЭЛ № ФС77-80505 - официальная регистрация |
| **Scimago 2024 (мир)** | #37 среди 5,467 СМИ мира - рядом с The New York Times |
...
| **Книга рекордов Гиннесса** | Мировой рекорд тиража: 21.9 млн копий (1990) |
| **The Guardian** | Названа "самой читаемой газетой России" |
| **Советские ордена** | Орден Ленина (1930), Орден Октябрьской Революции (1975), Орден Отечественной войны (1945), 2× Орден Трудового Красного Знамени |
| **Орден Почёта** | Государственная награда сотрудникам за вклад в развитие СМИ |
| **Runet Prize 2020** | Награда в категории "Культура, Медиа и Массовые коммуникации" |
| **Golden Website 2013** | Золото в категории Online Media (RIW) |
...
| **ComScore 2013** | Top-20 популярных европейских сайтов в категории News |
| **100-летие** | Юбилейное мероприятие в Президентской библиотеке (апрель 2025) |
| **Партнёрства с форумами** | Официальный медиа-партнёр ПМЭФ, ВЭФ, Российского инвестиционного форума |
| **Охват** | 89 регионов + 13 стран, офисы в США, Канаде, Австралии |
| **Traffic Report** | 75.45 млн посещений (май 2025) |
...
| Документ | Что доказывает |
|----------|----------------|
| **Лицензия Роскомнадзора** | ЭЛ № ФС 77-86651 (январь 2024) - официальная регистрация |
...
| **Рейтинги 2011-2022** | Стабильно в топе: #4 (2022), #2 (2019), #5 (2017) |
| **Digital Journalism 2024** | Лауреат конкурса - лучший источник аналитики по цифровым технологиям |
| **Digital Journalism 2023** | Победитель - один из лидеров IT-журналистики в России |
| **PR in IT Award 2016** | "Лучшее медиа об IT" |
| **Russoft Award 2021** | Награда за популяризацию IT-индустрии |
| **Цитирование в Коммерсанте** | Аналитические материалы цитируются ведущими федеральными бизнес-СМИ |
| **IT PRIZE** | Организатор национальной премии в сфере IT |
| **TAdviser SummIT** | Организатор крупнейших IT-конференций с участием лидеров рынка |
| **#1 среди порталов** | Первое место среди российских порталов цифровой экономики |
| **Доверие индустрии** | Лидер по доверию в опросах среди профессионалов цифровой отрасли |
| **Traffic Report** | 1.21 млн посещений (октябрь 2025) |
...
| Документ | Что доказывает |
|----------|----------------|
| **Explanatory Note** | Ключевая информация: 17 лет существования, охват, награды |
| **Лицензия Роскомнадзора** | Официальный статус в российском медиарынке |
| **Медиалогия 2025** | #9 среди самых цитируемых федеральных газет России (февраль 2025) |
| **Данные об аудитории** | 7 млн аудитория, 3+ млн читателей (офлайн + онлайн) |
| **"Золотое перо России"** | Главред награждён одной из самых престижных журналистских наград России |
| **Награда Союза журналистов РФ** | Главред - лауреат за редакционную колонку |
| **"Литера-2022"** | Журналист издания - победитель губернаторской премии Новосибирской области |
| **"Статус Медиа-2009"** | Номинация в категории "Медиа года" |
| **Партнёрства** | Сотрудничество с "Комсомольской Правдой" и другими ведущими изданиями |
| **Партнёрство с ФЗПР** | Генеральный партнёр Федерации зимнего плавания России |
| **Traffic Report** | 1.36 млн посещений в месяц (июль 2025) |
...
| Документ | Что доказывает |
|----------|----------------|
| **Explanatory Note** | Ключевая информация: возраст, охват, награды |
| **Лицензия Роскомнадзора** | Распространение в РФ и за рубежом - международный охват |
| **Данные о тираже** | Печатная версия 400,000+ копий в 5 странах, 1.2 млн читателей на выпуск |
...
| **Лидер продаж** | Победитель "Лидер продаж года" 2011 в категории "Развлекательная пресса" (3-й год подряд) |
| **Самое читаемое онлайн-СМИ** | Названо самым читаемым онлайн-медиа среди россиян |
| **Деловые СМИ о сделке** | Публикации в бизнес-СМИ о продаже издания - подтверждение статуса в Top-15 новостных ресурсов Рунета |
| **Lady Universe 2019** | Журналист издания - победитель международной премии в номинации "Lady Reporter" |
| **Traffic Report** | 2.96 млн посещений в месяц (апрель 2025) |
...
|----------|----------------|
| **Explanatory Note** | Ключевая информация: возраст, охват, награды |
| **Лучшая газета года 2018** | Национальная награда Киргизстана (источник: Kaktus.media) |
| **Лучшая газета года 2019** | Повторная национальная награда - устойчивое лидерство |
| **Top-25 по тиражу** | Среди 25 газет с наибольшим тиражом в Киргизстане (Vesti.kg) |
| **Top-5 самых читаемых** | Среди 5 самых читаемых СМИ страны (24.KG) |
| **Список ведущих СМИ** | В национальном каталоге влиятельных СМИ с высоким engagement |
| **LiveInternet** | #3 среди самых посещаемых медиа-сайтов Киргизстана |
| **BBC Media Guide** | BBC News признаёт Super.kg крупным киргизским СМИ с национальным охватом |
| **Soros Foundation Research** | Исследование медиа-предпочтений: Super-Info среди наиболее предпочитаемых источников информации |
...
| Документ | Что доказывает |
|----------|----------------|
| **Цитирование Newsweek** | 16 ноября 2023 - Newsweek (115 млн читателей) цитировал Dialog.ua как надёжный источник |
| **Semrush** | #243 в Украине, #10,870 в мире; 6.75 млн посещений, 8+ минут сессия |
| **SimilarWeb** | 25.21 млн посещений за Q1 2025; международная аудитория из Казахстана, Латвии, Германии |
| **SiteIndices** | #309 в Украине, #28,091 в мире; оценка $1.8 млн; 114,730 уникальных посетителей в день |
| **Мультиплатформенность** | YouTube, Telegram, Instagram, Facebook, Twitter |
| **Editorial Team** | Специализированные редакторы по разделам (Style, Show-biz, Lifestyle) |
| **Media Profile** | Социально-политическое издание с эксклюзивными комментариями политиков, журналистов, экспертов |
...
| Документ | Что доказывает |
|----------|----------------|
| **Institute of Mass Information** | Признание от IMI - ведущей медиа-организации Украины |
| **Eurotopics** | Включён в европейскую пресс-платформу как major Ukrainian news outlet |
| **Media Ownership Monitor** | Включён в проект мониторинга медиа-собственности Украины |
| **Media Kit** | 20 млн просмотров страниц в месяц |
| **SimilarWeb** | 2.3 млн посещений, 7 минут средняя сессия |
| **SEMrush** | Authority score 55, 2.1 млн backlinks |
| **Сравнение с конкурентами** | Выше Apostrophe.ua (35) и Vikna.tv (29) по authority score |
| **История** | Основан в 2005-2006, издатель Nova Informatsiya |
| **Аудитория** | 85% украинская аудитория |
...
| **Ukrainian People's Award 2024** | Повторное признание рядом с национальными телеканалами (Channel 24, M1, New Channel) |
| **Ahrefs** | 5.1 млн посещений, #21 в Украине, Top-1000 мира, Domain Authority 76 |
| **SimilarWeb** | 10.87 млн посещений, #56 в Украине |
| **SEMrush** | 4.34 млн посещений, +12.36% рост месяц к месяцу |
| **История платформы** | Основан в 2000 году - один из старейших украинских порталов |
| **Интерес Facebook/Meta** | Facebook проявлял интерес к покупке домена - подтверждение рыночной ценности |
| **Международный охват** | Аудитория в Польше, Германии, Казахстане |
...
| Документ | Что доказывает |
|----------|----------------|
| **Media Profile** | Основан в 2006, печатный тираж 32,000, 87.5K читателей на выпуск |
| **ON News рейтинг 2023** | #10 среди 1000+ новостных сайтов Украины |
| **Institute of Mass Information** | Top-10 украинских СМИ, 15.5 млн просмотров в месяц (Q2 2024) |
...
| **Соцсети** | 84.2K Facebook, 23.4K Twitter, 30 публикаций в день |
| **Semrush 2024** | 6.36 млн посещений, +8.47% рост месяц к месяцу |
| **SimilarWeb** | 16.57 млн посещений, +20.31% рост, #60 в Украине |
| **Аудитория** | 85-87% украинская аудитория, международный охват |
...
| Документ | Что доказывает |
|----------|----------------|
| **On-News Network** | Включён в ведущую рекламную платформу Украины для топовых национальных СМИ |
| **PrFlare** | Входит в список топовых украинских новостных сайтов наряду с Ukr.net, Pravda.com.ua, TSN.ua, RBC.ua |
| **PRNEWS.io** | Включён в топ-СМИ Украины рядом с Dialog.ua (7.7M), Apostrophe.ua (6.4M), Espreso.tv (6.7M) |
| **ZoomInfo** | Признан влиятельным онлайн-изданием с комплексным освещением глобальных событий, технологий и политики |
...
| **Domain Authority** | DR 54, DA 57 - сильный SEO-профиль и обширная ссылочная база |
| **"Человек года 2019"** | Официальный информационный партнёр национальной премии RBC-Ukraine |
| **Цитирование Kyiv Post** | Kyiv Post (ведущая англоязычная газета Украины) цитировала UAInfo.org как надёжный источник |
| **Цитирование Georgian Journal** | Международное цитирование грузинским изданием - признание за пределами Украины |
...
|----------|----------------|
| **Explanatory Note** | Ключевая информация: возраст, охват, награды |
| **Лицензия Роскомнадзора** | Свидетельство ЭЛ № ФС 77-72263 - официальная регистрация СМИ |
| **Медиалогия 2024** | #8 в Top-30 самых цитируемых интернет-ресурсов (индекс 465,900) |
| **Viral Media 2024** | #18 в рейтинге вирусных русскоязычных СМИ (индекс 74,000) |
| **Viral Media 2023** | #37 в Top-100 вирусных СМИ (индекс 57,526) |
| **Viral Media 2021** | #78 в Top-100 вирусных СМИ (индекс 36,414) |
| **Most Cited 2014** | #24 среди цитируемых СМИ в соцсетях (750,177 ссылок) |
| **Most Cited 2013** | #25 среди цитируемых СМИ (публикация статьи сенатора Джона Маккейна) |
| **Top Newspapers 2010** | #38 в Top-200 газет мира, #21 в Top-100 газет Европы |
| **Награда ЦИК РФ 2010** | Лучшее освещение выборов - награда Центральной избирательной комиссии |
| **Library of Congress** | Включен в веб-архив Библиотеки Конгресса США |
| **CEO Rating** | CEO издания #1230 среди 2.8 млн руководителей России |
| **Журналистский форум 2018** | Сертификат признания "Вся Россия" |
| **Traffic Report** | 21.11 млн посещений в месяц (июнь 2025) |
...
| Документ | Что доказывает |
|----------|----------------|
| **Свидетельство Роскомнадзора** | Регистрация № FS 77-77526, 31 декабря 2019 |
...
| **Brandanalytics январь 2025** | Входит в TOP-20 вирусных СМИ |
| **Коммерсант (2006)** | Освещение стратегического роста холдинга; партнёрство с "АиФ"; тираж 2.3 млн экземпляров в месяц |
| **Коммерсант (приобретение)** | Приобретение типографии Prime Print Воронеж - расширение инфраструктуры |
| **Награда КНР** | Журналист Михаил Морозов получил высшую правительственную награду Китая - Премию дружбы Госсовета КНР |
| **SimilarWeb** | 22+ млн посещений в месяц |
...
| Документ | Что доказывает |
|----------|----------------|
| **Свидетельство Роскомнадзора** | Регистрация № 302, 28 сентября 1993 - официальная регистрация СМИ |
...
| **ТАСС (25-летие)** | 5 млн читателей в неделю, тираж 3.32 млн, выручка 3.114 млрд руб. (2014), 27 стран, 30+ приложений, 22 сайта на 16 языках, 33 региональных филиала |
| **LiveInternet** | 2.5 млн посетителей за 31 день |
| **Traffic Analysis** | 31.38 млн посещений в месяц; топ-140 в России; #345 в глобальных новостях |
| **Золотое перо 2017** | Награда Союза журналистов России журналистам и первому зам. главреда РГ |
| **Золотое перо 2024** | Награда журналисту Николаю Долгополову |
| **DOT Journalism 2024** | Награда за достижения в журналистике |
| **Рейтинг юристов** | РГ создаёт престижный национальный рейтинг лучших юристов России |
...
| Документ | Что доказывает |
|----------|----------------|
| **Регистрация компании** | Rich Media Network Ltd, Лондон, 2016, регистрационный № 09907474 |
| **Media Profile** | Fintech, technology, business news; industry trends, emerging technologies |
| **Newswire Section** | Собственный раздел для распространения breaking news - роль distribution channel |
| **Silicon Valley Times** | Признано как "dynamic platform" для fintech-сообщества |
| **Major Media Citations** | Ведущие СМИ цитируют контент TechBullion - признание авторитета |
| **Crunchbase Profile** | Верификация как technology publication с фокусом на digital transformation |
| **SimilarWeb** | 1.21 млн посещений; аудитория: США (22.62%), Индия (9.50%), UK (7.63%), Пакистан (6.48%) |
...
{JSON.stringify({
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Что считается major media для O-1 и EB-1A?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Major media - это издания со значительной аудиторией в своей нише. USCIS оценивает: тираж/посещаемость, профессиональную направленность, редакционную политику. Forbes, Bloomberg, NYT - примеры major media. Отраслевые издания (TechCrunch для IT, Billboard для музыки) тоже подходят если доказать их значимость в индустрии."
      }
    },
    {
      "@type": "Question",
      "name": "Forbes Tech Council и Forbes Councils засчитываются для O-1/EB-1A?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Нет, Forbes Councils (Tech Council, Business Council и др.) обычно не засчитываются как published material about you. Это платные contributor-платформы где вы сами пишете статьи. USCIS требует материалы НАПИСАННЫЕ ДРУГИМИ о вас. Статья в Forbes Councils - это ваша авторская колонка, не публикация о вас."
      }
    },
    {
      "@type": "Question",
      "name": "Хабр, Medium, LinkedIn подходят для критерия СМИ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Обычно нет. Хабр, Medium и LinkedIn - это user-generated content платформы, где каждый может публиковать. USCIS не считает их major media. Исключение: если независимый журналист написал О ВАС статью на Medium с редакторской проверкой. Но это редкость."
      }
    },
    {
      "@type": "Question",
      "name": "Сколько публикаций в СМИ нужно для O-1 и EB-1A?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Минимального числа нет, но практика показывает: 3-5 качественных публикаций в major media лучше чем 20 в неизвестных изданиях. Важнее качество: публикации должны быть O ВАС (не вашей компании), в признанных СМИ, с указанием автора, даты и названия."
      }
    },
    {
      "@type": "Question",
      "name": "Платные публикации засчитываются для O-1/EB-1A?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Рискованно. USCIS может узнать что публикация платная (маркировка advertorial, sponsored content, или через проверку издания). Платные материалы могут быть расценены как marketing materials, которые прямо исключены из критерия. Лучше иметь органические публикации."
      }
    },
    {
      "@type": "Question",
      "name": "Интервью засчитывается как публикация о себе?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да, интервью может засчитываться если: (1) опубликовано в major media, (2) есть редакционная обработка (не просто транскрипт), (3) фокус на вашей работе и достижениях. Видео-интервью на YouTube-канале СМИ тоже может подойти при наличии транскрипта."
      }
    },
    {
      "@type": "Question",
      "name": "Какие российские и СНГ СМИ подходят для O-1/EB-1A?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Для IT: CNews, RBC, Vc.ru (с оговорками), Хабр (редко). Для бизнеса: Forbes Russia, Коммерсантъ, Ведомости, РБК. Для творческих: профильные отраслевые издания. Ключевое: доказать что издание major в своей нише через тираж, рейтинги, цитируемость."
      }
    },
    {
      "@type": "Question",
      "name": "Что делать если в статье нет автора?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "USCIS требует title, date И author. Без автора статья может быть отклонена. Решения: (1) найти автора через метаданные сайта или редакцию, (2) получить письмо от редакции с подтверждением авторства, (3) показать что это редакционная политика издания (например, Reuters часто не указывает авторов)."
      }
    }
  ]
})}
