  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px'}}>
    ...
    <div>
      ...
      <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
        ...
        <span style={{fontSize: '12px', color: '#18181b', background: '#e4e4e7', padding: '4px 10px', borderRadius: '12px', fontWeight: '500'}}>145+ цитат из RFE</span>
      </div>
    </div>
  </div>
...
↳ *Критически важно: статьи опубликованные ПОСЛЕ даты подачи I-140 - "not probative" (не имеют доказательной силы). Matter of Katigbak = стандартная ссылка. Все публикации должны быть датированы ДО filing date.*

<Warning>
Собирайте статьи ЗАРАНЕЕ! Публикации после подачи петиции не засчитываются.
</Warning>
