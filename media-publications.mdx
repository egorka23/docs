  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px'}}>
    ...
    <div>
      ...
      <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
        ...
        <span style={{fontSize: '12px', color: '#18181b', background: '#e4e4e7', padding: '4px 10px', borderRadius: '12px', fontWeight: '500'}}>140+ цитат из RFE</span>
      </div>
    </div>
  </div>
...
На **Final Merits** офицер может написать:
...
> "As the evidence that meets the criteria is dated 2025, the record is insufficient to demonstrate that the beneficiary has sustained national or international acclaim."

↳ *Офицер говорит: публикации за 2 года не показывают "sustained acclaim" и не доказывают что вы входите в "small percentage at the very top" области.*
...
**Как смягчить риск:**
- Покажите карьерный рост и достижения ДО 2024 года (даже если без публикаций)
- Объясните почему медиа-признание пришло именно сейчас (крупный проект, прорыв)
- Добавьте другие доказательства sustained acclaim (цитирования, награды за разные годы)
